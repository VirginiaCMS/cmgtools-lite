...
#        if sample=='DYJetsToLL_M50_MGMLM_BIG': dataPlotters[-1].addCorrectionFactor('ZPtWeight*0.981151','ZPtWeight')
        if sample=='DYJetsToLL_M50_MGMLM_BIG': dataPlotters[-1].addCorrectionFactor('ZPtWeight*1.009036','ZPtWeight')
...
#    Stack.drawStack('llnunu_l1_mass', cuts, str(lumi*1000), 13, 50, 180, titlex = "M(Z)", units = "GeV",output=tag+'zmass',outDir=outdir,separateSignal=sepSig)
